...
import { Users, ArrowRight, Check, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-dark-950 text-white overflow-hidden">
      ...
      <main className="relative">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight">
                Turn Your Followers Into Paying Members
              </h1>
              <p className="text-lg md:text-xl text-dark-300 mb-8 max-w-2xl mx-auto leading-relaxed">
                Monetize your audience with memberships, exclusive content, and private access — without relying on social media platforms.
              </p>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-dark-900/50 border border-dark-800 rounded-3xl p-8 md:p-12">
                ...
                <p className="text-dark-300 text-lg mb-6 leading-relaxed">
                  Many creators already charge manually through WhatsApp or Mobile Money, but it doesn't scale.
                </p>
                <ul className="space-y-3">
                  {["Access is hard to manage", "Subscriptions expire unnoticed", "Everything depends on manual work"].map((point, index) => (
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-dark-300 text-lg mb-4 leading-relaxed">
                Payssd professionalizes creator monetization.
              </p>
              <p className="text-dark-400 leading-relaxed">
                Fans pay you directly. Payssd manages access automatically.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 relative">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <h3 className="text-xl font-bold mb-6 text-white text-center">What you can offer</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {["Private communities", "Exclusive updates", "Fan clubs", "Membership content"].map((item, index) => (
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  { title: "Create a membership plan", description: "Choose monthly, yearly, or one-time access." },
                  { title: "Share your checkout link", description: "Fans pay directly to you." },
                  { title: "Access is managed automatically", description: "Active members get access. Expired ones lose it." }
                ].map((step, index) => (
        ...
        <section className="py-20 relative">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold mb-8 text-white text-center">Why creators use Payssd</h2>
              <div className="grid sm:grid-cols-2 gap-4">
                {["No platform restrictions", "No fund holding", "Simple and professional setup", "Built for local payments"].map((feature, index) => (
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <div className="bg-gradient-to-br from-lemon-400/10 to-grape-500/10 border border-lemon-400/20 rounded-3xl p-8 md:p-12">
                ...
                <p className="text-dark-400">You stay in full control of revenue and fans.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 relative">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-dark-300 text-lg mb-8">Join creators already using Payssd to monetize their audience.</p>
              <Link href="/auth/register" className="btn-primary btn-lg inline-flex items-center gap-2">
                Monetize Your Audience
                <ArrowRight className="h-5 w-5" />
              </Link>
