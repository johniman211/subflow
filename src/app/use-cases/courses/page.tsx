...
import { BookOpen, ArrowRight, Check, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-dark-950 text-white overflow-hidden">
      ...
      <main className="relative">
        ...
        <section className="relative py-20 lg:py-32">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="w-16 h-16 bg-grape-500 rounded-2xl flex items-center justify-center mx-auto mb-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight">
                Sell Courses and Digital Products Without Manual Work
              </h1>
              <p className="text-lg md:text-xl text-dark-300 mb-8 max-w-2xl mx-auto leading-relaxed">
                Stop chasing payments and sending files manually. Payssd helps you sell courses and digital products with automatic access control.
              </p>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-dark-900/50 border border-dark-800 rounded-3xl p-8 md:p-12">
                ...
                <p className="text-dark-300 text-lg mb-6 leading-relaxed">
                  Selling courses online often means manual work that doesn't scale.
                </p>
                <ul className="space-y-3">
                  {["Manual payment confirmation", "Sending files one by one", "No control when access should expire"].map((point, index) => (
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-dark-300 text-lg mb-4 leading-relaxed">
                Payssd automates the entire flow.
              </p>
              <p className="text-dark-400 leading-relaxed">
                Students pay you directly. Access is unlocked automatically and removed when it expires.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 relative">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <h3 className="text-xl font-bold mb-6 text-white text-center">What you can sell</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {["Online courses", "Training programs", "PDFs and resources", "Subscription content"].map((item, index) => (
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  { title: "Create your course or product", description: "Set pricing and access rules." },
                  { title: "Share your checkout link", description: "Students pay using Mobile Money or bank transfer." },
                  { title: "Access is managed automatically", description: "Only paid users get access." }
                ].map((step, index) => (
        ...
        <section className="py-20 relative">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold mb-8 text-white text-center">Why educators use Payssd</h2>
              <div className="grid sm:grid-cols-2 gap-4">
                {["No manual follow-up", "No technical setup", "Professional payment flow", "Built for local markets"].map((feature, index) => (
        ...
        <section className="py-20 relative">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-dark-300 text-lg mb-8">Join educators already using Payssd to sell courses.</p>
              <Link href="/auth/register" className="btn-primary btn-lg inline-flex items-center gap-2">
                Start Selling Courses
                <ArrowRight className="h-5 w-5" />
              </Link>
