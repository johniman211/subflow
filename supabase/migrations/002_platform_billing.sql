...
VALUES 
  (
    ...
    0,
    'USD',
    '["Up to 50 subscribers", "Basic dashboard", "Email support", "Checkout links"]',
    '{"max_subscribers": 50, "api_access": false, "webhooks": false, "custom_branding": false, "analytics": "basic"}',
    true,
    false,
    0,
    1
